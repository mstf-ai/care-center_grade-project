...
<head>
    ...
    <title>Rest Password-Care Center</title>
...
<body>
    <div class="auth p-5"
        style="background: linear-gradient(to right, orange ,  rgb(0, 221, 173) , rgb(255, 217, 0) ); , padding-bottom: :160px">
        ...
        <div class="container pt-5">
            <div class="row g-5 pt-4">
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                        ...
                        <a class="text-light mb-2" href="about"><i
                            ...
                            Us</a>
                        <a class="text-light mb-2" href="service"><i class="bi bi-arrow-right text-warning me-2"></i>Our
                            Services</a>
                        <a class="text-light" href="contact"><i class="bi bi-arrow-right text-warning me-2"></i>Contact
                            Us</a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="bi bi-envelope-open text-warning me-2"></i>carecenter1222@gmail.com
                    </p>
                    <p class="mb-0"><i class="bi bi-telephone text-warning me-2"></i>+02 0109 780 0538</p>
                </div>
                <div class="col-lg-3 col-md-6">
