        ...
        <div class="container pt-5">
            <div class="row g-5 pt-4">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="bi bi-geo-alt text-warning me-2"></i>{{setting('site.address')}}
                    </p>
                    <p class="mb-2"><i class="bi bi-envelope-open text-warning me-2"></i>{{setting('site.email')}}
                    </p>
